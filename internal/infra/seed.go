...
3. 直接輸出最終 JSON，不要先回中間結果`,
	...
	theoryMappings := []TheoryMapping{
		{
			MappingID:      "linkchat-astrology-astro-v1-sun-sign-capricorn",
			AppID:          "linkchat",
			ModuleKey:      "astrology",
			TheoryVersion:  "astro-v1",
			SlotKey:        "sun_sign",
			RawValue:       "Capricorn",
			InternalCode:   "ASTRO_SUN_CAP_01",
			Interpretation: "steady|disciplined|enduring",
			Active:         true,
		},
		{
			MappingID:      "linkchat-astrology-astro-v1-sun-sign-magicapricorn",
			AppID:          "linkchat",
			ModuleKey:      "astrology",
			TheoryVersion:  "astro-v1",
			SlotKey:        "sun_sign",
		...
		{
			MappingID:      "linkchat-astrology-astro-v1-sun-sign-capricorn-zh",
			AppID:          "linkchat",
			ModuleKey:      "astrology",
			TheoryVersion:  "astro-v1",
			SlotKey:        "sun_sign",
		...
		{
			MappingID:      "linkchat-astrology-astro-v1-sun-sign-scorpio",
			AppID:          "linkchat",
			ModuleKey:      "astrology",
			TheoryVersion:  "astro-v1",
			SlotKey:        "sun_sign",
			RawValue:       "Scorpio",
			InternalCode:   "ASTRO_SUN_SCO_01",
			Interpretation: "intense|probing|transformative",
			Active:         true,
		},
		{
			MappingID:      "linkchat-astrology-astro-v1-sun-sign-scorpio-zh",
			AppID:          "linkchat",
			ModuleKey:      "astrology",
			TheoryVersion:  "astro-v1",
			SlotKey:        "sun_sign",
		...
		{
			MappingID:      "linkchat-astrology-astro-v1-moon-sign-pisces",
			AppID:          "linkchat",
			ModuleKey:      "astrology",
			TheoryVersion:  "astro-v1",
			SlotKey:        "moon_sign",
			RawValue:       "Pisces",
			InternalCode:   "ASTRO_MOON_PIS_01",
			Interpretation: "absorbing|sensitive|fluid",
			Active:         true,
		},
		{
			MappingID:      "linkchat-astrology-astro-v1-moon-sign-pisces-zh",
			AppID:          "linkchat",
			ModuleKey:      "astrology",
			TheoryVersion:  "astro-v1",
			SlotKey:        "moon_sign",
		...
		{
			MappingID:      "linkchat-astrology-astro-v1-moon-sign-gemini",
			AppID:          "linkchat",
			ModuleKey:      "astrology",
			TheoryVersion:  "astro-v1",
			SlotKey:        "moon_sign",
			RawValue:       "Gemini",
			InternalCode:   "ASTRO_MOON_GEM_01",
			Interpretation: "quick|curious|restless",
			Active:         true,
		},
		{
			MappingID:      "linkchat-astrology-astro-v1-moon-sign-gemini-zh",
			AppID:          "linkchat",
			ModuleKey:      "astrology",
			TheoryVersion:  "astro-v1",
			SlotKey:        "moon_sign",
